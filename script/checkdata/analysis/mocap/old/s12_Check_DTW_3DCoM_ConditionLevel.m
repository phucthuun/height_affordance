...
%  Performs multidimensional DTW across condition groups using native 
%  [3 x Frames] matrices where feature dimensions (rows) match exactly.
%
...
%% 9. Multidimensional Dynamic Time Warping (MD-DTW) Condition Comparison
fprintf('\nRunning Multidimensional Dynamic Time Warping Analysis...\n');
...
for groupA = 1:numConditions
    ...
    for groupB = 1:numConditions
        ...
        for i = 1:numTrialsA
            ...
            % Ensure matrix is valid and contains at least 2 time-frames
            ...
            for j = 1:numTrialsB
                ...
                % Pass matrices natively as [3 x Frames]. 
                % MATLAB expects the shared dimensions (3 rows) to be identical,
                % and it warps the columns (varying frames) automatically.
...
figure('Name', 'CoM_Trajectory_DTW_Heatmap', 'Color', 'w', ...
...
title('3D-CoM Trajectory Structural Dissimilarity Matrix (MD-DTW)', 'FontSize', 14, 'FontWeight', 'bold');
