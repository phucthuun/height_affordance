...
%% General Setup
bemobil_config.upper_folder = fullfile('/mnt/beegfs/home/', getenv('USER'), '1223-xplo-judo', '10_Data');
...
bemobil_config.filter_lowCutoffFreqAMICA = 1.75; % 1.5 is 1.25Hz cutoff with 1650 filter order!
