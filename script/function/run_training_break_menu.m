function choice = run_training_break_menu(currentBlock, log)
...
% without affecting the active Psychtoolbox visual presentation display.
    ...
    countdownDuration = 60; % 7 Minutes in seconds
    ...
    uicontrol(f, 'Style', 'text', ...
              'String', sprintf(['TRAINING DONE: NO COOLING %d \n' ...
              'STOP AND SAVE data streams. Has Participant understood task?'], currentBlock), ...
