function masterTrials = stimuli_randomize_preload_double32(stimDir, numBlocks)
...
if exist(mat_file, 'file')
    ...
    for b = 1:numBlocks
        ...
        % --- CORRECTED MODERN MEMORY MANAGEMENT ---
        clear shuff duplicatedPairs;  % Wipe the transient duplicate references
        java.lang.System.gc();         % Command Java virtual machine to release unallocated memory chunks
    end
